...
\lstinputlisting[language=Java, firstline=35, lastline=241, caption=Static Constraints]{../configproject/xtext/org.xtext.example.smdpdsl/src/org/xtext/example/mydsl/validation/SmdpDslvalidator.xtend}
...
\lstinputlisting[language=Java, firstline=7, lastline=82, caption=Xtext Grammar from SmdpDsl.xtext]{../configproject/xtext/org.xtext.example.smdpdsl/src/org/xtext/example/mydsl/SmdpDsl.xtext}
...
\lstinputlisting[language=Java, firstline=252, lastline=272, caption=part of  generateIfConstraintString method from JavaCodeGenerator.xtend]{../configproject/xtext/org.xtext.example.smdpdsl/src/org/xtext/example/mydsl/generator/JavaCodeGenerator.xtend}
...
\lstinputlisting[language=Java, firstline=313, lastline=334,caption=part of generateThenConstraintString method from JavaCodeGenerator.xtend]{../configproject/xtext/org.xtext.example.smdpdsl/src/org/xtext/example/mydsl/generator/JavaCodeGenerator.xtend}
...
\lstinputlisting[language=Java, firstline=27, lastline=79,caption=Test examples from SmdpDslValidatorTest.xtend]{../configproject/xtext/org.xtext.example.smdpdsl.tests/src/org/xtext/example/smdpdsl/tests/SmdpDslValidatorTest.xtend}

\lstinputlisting[language=Java, firstline=100, lastline=117,caption=Test examples from SmdpDslValidatorTest.xtend]{../configproject/xtext/org.xtext.example.smdpdsl.tests/src/org/xtext/example/smdpdsl/tests/SmdpDslValidatorTest.xtend}

\lstinputlisting[language=Java, firstline=165, lastline=277,caption=Test examples from SmdpDslValidatorTest.xtend]{../configproject/xtext/org.xtext.example.smdpdsl.tests/src/org/xtext/example/smdpdsl/tests/SmdpDslValidatorTest.xtend}
